namespace WaterCity.Core.Constants
{
    ...
    public class ReponseMessageConstantsPhiDuyTri
    {
        public const string PHI_DUY_TRI_NOT_FOUND = "Khong tim thay phi duy tri.";
        public const string PHI_DUY_TRI_EXISTED = "Phi duy tri da ton tai.";
        public const string UPDATE_PHI_DUY_TRI_SUCCESS = "Cap nhat phi duy tri thanh cong.";
        public const string DELETE_PHI_DUY_TRI_SUCCESS = "Xoa phi duy tri thanh cong.";
    }
    ...
    public class ReponseMessageConstantsLyDoHuy
    {
        public const string LYDOHUY_NOT_FOUND = "Khong tim thay ly do huy.";
        public const string LYDOHUY_EXISTED = "Ly do huy da ton tai.";
        public const string UPDATE_LYDOHUY_SUCCESS = "Cap nhat ly do huy thanh cong.";
        public const string DELETE_LYDOHUY_SUCCESS = "Xoa ly do huy thanh cong.";
    }
    ...
    public class ReponseMessageConstantsLopHoc
    {
        public const string LOPHOC_NOT_FOUND = "Khong tim thay lop hoc.";
        public const string LOPHOC_EXISTED = "Lop hoc da ton tai.";
        public const string UPDATE_LOPHOC_SUCCESS = "Cap nhat lop hoc thanh cong.";
        public const string DELETE_LOPHOC_SUCCESS = "Xoa lop hoc thanh cong.";
    }
    public class ReponseMessageConstantsHocSinh
    {
        public const string HOCSINH_NOT_FOUND = "Khong tim thay hoc sinh.";
        public const string HOCSINH_EXISTED = "Hoc sinh da ton tai.";
        public const string UPDATE_HOCSINH_SUCCESS = "Cap nhat hoc sinh thanh cong.";
        public const string DELETE_HOCSINH_SUCCESS = "Xoa hoc sinh thanh cong.";
    }
    public class ReponseMessageConstantsLoaiMon
    {
        public const string LOAIMON_NOT_FOUND = "Khong tim thay loai mon.";
        public const string LOAIMON_EXISTED = "Loai mon da ton tai.";
        public const string UPDATE_LOAIMON_SUCCESS = "Cap nhat loai mon thanh cong.";
        public const string DELETE_LOAIMON_SUCCESS = "Xoa loai mon thanh cong.";
    }
    public class ReponseMessageConstantsMon
    {
        public const string MON_NOT_FOUND = "Khong tim thay mon.";
        public const string MON_EXISTED = "Mon da ton tai.";
        public const string UPDATE_MON_SUCCESS = "Cap nhat mon thanh cong.";
        public const string DELETE_MON_SUCCESS = "Xoa mon thanh cong.";
    }
    public class ReponseMessageConstantsKhachHangMon
    {
        public const string KHACHHANGMON_NOT_FOUND = "Khong tim thay KhachHangMon.";
        public const string KHACHHANGMON_EXISTED = "KhachHangMon da ton tai.";
        public const string UPDATE_KHACHHANGMON_SUCCESS = "Cap nhat KhachHangMon thanh cong.";
        public const string DELETE_KHACHHANGMON_SUCCESS = "Xoa KhachHangMon thanh cong.";
    }
    public class ReponseMessageConstantsHoaDonMon
    {
        public const string HOADONMON_NOT_FOUND = "Khong tim thay HoaDonMon.";
        public const string HOADONMON_EXISTED = "HoaDonMon da ton tai.";
        public const string UPDATE_HOADONMON_SUCCESS = "Cap nhat HoaDonMon thanh cong.";
        public const string DELETE_HOADONMON_SUCCESS = "Xoa HoaDonMon thanh cong.";
    }
    public class ReponseMessageConstantsCTHDMon
    {
        public const string CTHDMON_NOT_FOUND = "Khong tim thay CTHDMon.";
        public const string CTHDMON_EXISTED = "CTHDMon da ton tai.";
        public const string UPDATE_CTHDMON_SUCCESS = "Cap nhat CTHDMon thanh cong.";
        public const string DELETE_CTHDMON_SUCCESS = "Xoa CTHDMon thanh cong.";
    }
}
