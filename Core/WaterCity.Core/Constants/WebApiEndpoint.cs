namespace WaterCity.Core.Constants
{
    public static class WebApiEndpoint
    {
        ...
        {
            private const string BaseEndpoint = "~/" + AreaName + "/lop-hoc";
            public const string GetLopHoc = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllLopHoc = BaseEndpoint + "/get-all";
            public const string AddLopHoc = BaseEndpoint + "/add";
            public const string UpdateLopHoc = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteLopHoc = BaseEndpoint + "/delete" + "/{keyId}";
        }
        public static class HocSinh
        {
            private const string BaseEndpoint = "~/" + AreaName + "/hoc-sinh";
            public const string GetHocSinh = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllHocSinh = BaseEndpoint + "/get-all";
            public const string AddHocSinh = BaseEndpoint + "/add";
            public const string UpdateHocSinh = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteHocSinh = BaseEndpoint + "/delete" + "/{keyId}";
        }
        public static class LoaiMon
        {
            private const string BaseEndpoint = "~/" + AreaName + "/loai-Mon";
            public const string GetLoaiMon = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllLoaiMon = BaseEndpoint + "/get-all";
            public const string AddLoaiMon = BaseEndpoint + "/add";
            public const string UpdateLoaiMon = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteLoaiMon = BaseEndpoint + "/delete" + "/{keyId}";
        }
        public static class Mon
        {
            private const string BaseEndpoint = "~/" + AreaName + "/Mon";
            public const string GetMon = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllMon = BaseEndpoint + "/get-all";
            public const string AddMon = BaseEndpoint + "/add";
            public const string UpdateMon = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteMon = BaseEndpoint + "/delete" + "/{keyId}";
        }
        public static class KhachHangMon
        {
            private const string BaseEndpoint = "~/" + AreaName + "/khach-hang-mon";
            public const string GetKhachHangMon = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllKhachHangMon = BaseEndpoint + "/get-all";
            public const string AddKhachHangMon = BaseEndpoint + "/add";
            public const string UpdateKhachHangMon = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteKhachHangMon = BaseEndpoint + "/delete" + "/{keyId}";
        }
        public static class HoaDonMon
        {
            private const string BaseEndpoint = "~/" + AreaName + "/hoa-don-mon";
            public const string GetHoaDonMon = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllHoaDonMon = BaseEndpoint + "/get-all";
            public const string AddHoaDonMon = BaseEndpoint + "/add";
            public const string UpdateHoaDonMon = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteHoaDonMon = BaseEndpoint + "/delete" + "/{keyId}";
        }
        public static class CTHDMon
        {
            private const string BaseEndpoint = "~/" + AreaName + "/CTHD-Mon";
            public const string GetCTHDMon = BaseEndpoint + "/get-single" + "/{keyId}";
            public const string GetAllCTHDMon = BaseEndpoint + "/get-all";
            public const string AddCTHDMon = BaseEndpoint + "/add";
            public const string UpdateCTHDMon = BaseEndpoint + "/update" + "/{keyId}";
            public const string DeleteCTHDMon = BaseEndpoint + "/delete" + "/{keyId}";
        }
