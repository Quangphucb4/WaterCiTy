...
namespace WaterCity.Repository.Migrations
{
    ...
    [Migration("20230727080041_DeMo_APIHUFI")]
    partial class DeMo_APIHUFI
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.CTHDMonEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HoaDonMonEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("KhachHangmonsId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("KhachHangmonsId");

                    b.ToTable("HoaDonMon");
                });

            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HocSinhEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.KhachHangMonEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.LoaiMonEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.LopHocEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("HocSinhEntityId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.MonEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.CTHDMonEntity", b =>
                {
                    b.HasOne("WaterCity.Contract.Repository.Models.HoaDonMonEntity", "HoaDonMon")
                        .WithMany()
                        .HasForeignKey("MaHDID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WaterCity.Contract.Repository.Models.MonEntity", "mons")
                        .WithMany()
                        .HasForeignKey("monsId");

                    b.Navigation("HoaDonMon");
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.HoaDonMonEntity", b =>
                {
                    b.HasOne("WaterCity.Contract.Repository.Models.KhachHangMonEntity", "KhachHangmons")
                        .WithMany()
                        .HasForeignKey("KhachHangmonsId");

                    b.Navigation("KhachHangmons");
                });
            ...
            modelBuilder.Entity("WaterCity.Contract.Repository.Models.LopHocEntity", b =>
                {
                    b.HasOne("WaterCity.Contract.Repository.Models.HocSinhEntity", null)
                        .WithMany("LopHocs")
                        .HasForeignKey("HocSinhEntityId");
                });

            modelBuilder.Entity("WaterCity.Contract.Repository.Models.MonEntity", b =>
                {
                    b.HasOne("WaterCity.Contract.Repository.Models.LoaiMonEntity", "Loai")
                        .WithMany("mons")
