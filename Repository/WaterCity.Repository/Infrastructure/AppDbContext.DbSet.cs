...
namespace WaterCity.Repository.Infrastructure
{
    public sealed partial class AppDbContext
    {
        ...
        public DbSet<LopHocEntity> lh { get; set; }
        public DbSet<HocSinhEntity> hs { get; set; }
        public DbSet<MonEntity> MonAN { get; set; }
        public DbSet<LoaiMonEntity> LoaiMon { get; set; }
        public DbSet<HoaDonMonEntity> HDMon { get; set; }
        public DbSet<KhachHangMonEntity> KhMon { get; set; }
        public DbSet<CTHDMonEntity> CTHDMon { get; set; }
    }
}
