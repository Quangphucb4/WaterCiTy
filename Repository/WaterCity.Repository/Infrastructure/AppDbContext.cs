    ...
    public sealed partial class AppDbContext : BaseDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                connectionString = "Data Source=DESKTOP-0EBQ24P\\SQLEXPRESS;Initial Catalog=DemoAPI3;user=sa;pwd=123;Trusted_Connection=True;Trust Server Certificate=True; Integrated Security=false";
